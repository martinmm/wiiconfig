 ...
 */
  ...
  /********                          Failsafe settings                 ********************/
    ...
    #define FAILSAFE_THROTTLE  (MINTHROTTLE + 80)    // (*) Throttle level used for landing - may be relative to MINTHROTTLE - as in this case
  ...
  /**************************************************************************************/
   ...
   /* GPS protocol 
    ...
    #define MAG_DECLINATION  2.4f   // Wolfsburg/Hehlingen (**)
    //#define MAG_DECLINATION  2.22f   // Ostheim
  ...
  /********************************************************************/
    ...
    #define VBATSCALE       120 // (*) (**) change this value if readed Battery voltage is different than real voltage
    #define VBATNOMINAL     126 // 12,6V full battery nominal voltage - only used for lcd.telemetry
    #define VBATLEVEL_WARN1 100 // (*) (**) 10,7V
    #define VBATLEVEL_WARN2 100 // (*) (**) 9.9V
    #define VBATLEVEL_CRIT   85 // (*) (**) 9.3V - critical condition: if vbat ever goes below this value, permanent alarm is triggered
